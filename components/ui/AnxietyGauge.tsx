...
import { getAnxietyColor } from '@/services/mockData';
...
export function AnxietyGauge({ value, size = 180 }: AnxietyGaugeProps) {
  const { label, color } = getAnxietyColor(Math.round(value));
